<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:73:"C:\WWW\thinkphp\10\public/../application/admin\view\auth_group\index.html";i:1466688923;s:68:"C:\WWW\thinkphp\10\public/../application/admin\view\base\common.html";i:1466693463;s:68:"C:\WWW\thinkphp\10\public/../application/admin\view\public\head.html";i:1466565979;s:70:"C:\WWW\thinkphp\10\public/../application/admin\view\public\navbar.html";i:1466782432;s:71:"C:\WWW\thinkphp\10\public/../application/admin\view\public\sidebar.html";i:1466602410;s:70:"C:\WWW\thinkphp\10\public/../application/admin\view\public\script.html";i:1466653052;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
	    <meta charset="utf-8" />
                    ...
                    <ul class="account-area">
                        <li>
                            <a class="login-area dropdown-toggle" data-toggle="dropdown">
                                ...
                                <section>
                                    <h2><span class="profile"><span><?php echo $_SESSION['user_auth']['username']; ?></span></span></h2>
                                </section>
                            </a>
                            <!--Login Area Dropdown-->
...
<button type="button" tooltip="添加角色" class="btn btn-sm btn-azure btn-addon" onclick="javascript:window.location.href = '<?php echo url('auth_group/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
            ...
            <div class="widget-body">
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if(is_array($roles) || $roles instanceof \think\Collection): $i = 0; $__LIST__ = $roles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$role): $mod = ($i % 2 );++$i;?>
                            <tr>
                                <td align="center"><?php echo $role['id']; ?></td>
                                <td align="center"><?php echo $role['title']; ?></td>
                                <td align="center">
                                    <a href="<?php echo url('auth_group/edit',['id'=>$role['id']]); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onclick="warning('确实要删除吗', '<?php echo url('auth_group/del',['id'=>$role['id']]); ?>')" class="btn btn-danger btn-sm shiny">
                                        <i class="fa fa-trash-o"></i> 删除
                                    </a>
                                    <a href="<?php echo url('auth_group/resource',['id'=>$role['id']]); ?>" class="btn btn-sky btn-sm shiny">
