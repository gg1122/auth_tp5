<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:76:"C:\WWW\thinkphp\10\public/../application/admin\view\auth_group\resource.html";i:1466738568;s:68:"C:\WWW\thinkphp\10\public/../application/admin\view\base\common.html";i:1466693463;s:68:"C:\WWW\thinkphp\10\public/../application/admin\view\public\head.html";i:1466565979;s:70:"C:\WWW\thinkphp\10\public/../application/admin\view\public\navbar.html";i:1466688711;s:71:"C:\WWW\thinkphp\10\public/../application/admin\view\public\sidebar.html";i:1466602410;s:70:"C:\WWW\thinkphp\10\public/../application/admin\view\public\script.html";i:1466653052;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
	    <meta charset="utf-8" />
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-sky">
                <span class="widget-caption">设置资源:<?php echo $data['title']; ?></span>
            </div>
            <div class="widget-body">
                <form method="POST" action="">
                    <table cellspacing="1" id="rs" class="table table-bordered table-hover">
                        <?php if(is_array($resource) || $resource instanceof \think\Collection): $i = 0; $__LIST__ = $resource;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <tr class="r1">
                            <td>
                                <div class="col-lg-12 col-sm-12 col-xs-12">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" class="inverted" name="resource[]" value="<?php echo $vo['id']; ?>" <?php if(in_array(($vo['id']), is_array($data['rules'])?$data['rules']:explode(',',$data['rules']))): ?>checked<?php endif; ?>>
                            ...
                            <td>
                                <?php if(isset($vo['child'])): if(is_array($vo['child']) || $vo['child'] instanceof \think\Collection): $i = 0; $__LIST__ = $vo['child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?>
                                <div>
                                    <div class="col-lg-12 col-sm-12 col-xs-12 r2" style="background:#ccc;">
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" class="inverted" name="resource[]" value="<?php echo $vo1['id']; ?>" <?php if(in_array(($vo1['id']), is_array($data['rules'])?$data['rules']:explode(',',$data['rules']))): ?>checked<?php endif; ?>>
                                                <span class="text"><?php echo $vo1['title']; ?></span>
                                            </label>
                                        </div>
                                    </div>
                                    <?php if(isset($vo1['child'])): if(is_array($vo1['child']) || $vo1['child'] instanceof \think\Collection): $i = 0; $__LIST__ = $vo1['child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i;?>
                                    <div class="col-lg-2 col-sm-2 col-xs-2 r3">
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" class="inverted" name="resource[]" value="<?php echo $vo2['id']; ?>" <?php if(in_array(($vo2['id']), is_array($data['rules'])?$data['rules']:explode(',',$data['rules']))): ?>checked<?php endif; ?>>
